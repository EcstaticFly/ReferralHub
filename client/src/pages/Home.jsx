...
const menuItems = [
  ...
  { name: "Profile", icon: <User size={20} />, component: <Profile /> },
];
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      >
        ...
        <nav className="flex flex-col h-full p-4 space-y-8">
          ...
          <button
            className="bg-red-800 flex mt-5 items-center gap-3 p-4 text-left rounded transition duration-200 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300"
            onClick={logout}
          >
